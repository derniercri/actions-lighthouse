...
lhci autorun --chrome-flags="google-chrome-stable --headless" --collect.url="$1" --collect.numberOfRuns="1" --upload.target="filesystem" --upload.outputDir="./report-lhci" --upload.ignoreDuplicateBuildFailure"true" --no-lighthouserc="true"
wait $!
